...
#ifndef GOOPY_BASE_STL_UTIL_H_
#define GOOPY_BASE_STL_UTIL_H_
...
#include <ext/algorithm> // __gnu_cxx::is_heap for util/gtl/algorithm.h
#endif

#include "base/algorithm.h" // for util::gtl::is_sorted
...
// Array version of STLDeleteContainerPointers. Used to delete those pointers
// created by new[].
template <class ForwardIterator>
void STLDeleteContainerArrays(ForwardIterator begin,
                              ForwardIterator end) {
  while (begin != end) {
    ForwardIterator temp = begin;
    ++begin;
...
// Array version of STLDeleteContainerPairFirstPointers.
// Used to delete those pointers created by new[].
template <class ForwardIterator>
void STLDeleteContainerPairFirstArrays(ForwardIterator begin,
                                       ForwardIterator end) {
  while (begin != end) {
    ForwardIterator temp = begin;
    ++begin;
...
// Array version of STLDeleteContainerPairSecondPointers.
// Used to delete those pointers created by new[].
template <class ForwardIterator>
void STLDeleteContainerPairSecondArrays(ForwardIterator begin,
                                        ForwardIterator end) {
  while (begin != end) {
    ForwardIterator temp = begin;
    ++begin;
