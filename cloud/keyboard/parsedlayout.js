 ...
 *     and expose the keymappings to KeyboardView and the transforms to
 *     KeyboardController.
 *
 */

goog.provide('i18n.input.keyboard.ParsedLayout');
 ...
 * @constructor
 */
i18n.input.keyboard.ParsedLayout = function(layout) {
  /**
  ...
  /**
   * The parsed layout transforms. There are only 2 elements of this array.
   * One is the long exgexp to match, the other is the map of:
 ...
 * @private
 */
i18n.input.keyboard.ParsedLayout.prototype.parseKeyMappings_ = function(
    layout) {
  var codes = this.view.is102 ? i18n.input.keyboard.KeyCode.CODES102 :
 ...
 * @private
 */
i18n.input.keyboard.ParsedLayout.prototype.parseTransforms_ = function(
    layout) {
 ...
 */
i18n.input.keyboard.ParsedLayout.prototype.transform = function(
    prevstr, transat, ch) {
 ...
 *     otherwise.
 */
i18n.input.keyboard.ParsedLayout.prototype.isAmbiChars = function(chars) {
