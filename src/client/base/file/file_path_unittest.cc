...
TEST_F(FilePathTest, Extension2) {
  const struct UnaryTestData cases[] = {
    ...
    { FPL("/foo.tar.gz"),            FPL(".gz") },
    { FPL("/foo.tar.Z"),             FPL(".Z") },
    { FPL("/foo.tar.bz2"),           FPL(".bz2") },
    { FPL("/subversion-1.6.12.zip"), FPL(".zip") },
    { FPL("/foo.1234.gz"),           FPL(".gz") },
    { FPL("/foo.12345.gz"),          FPL(".gz") },
    { FPL("/foo..gz"),               FPL(".gz") },
    { FPL("/foo.1234.tar.gz"),       FPL(".gz") },
    { FPL("/foo.tar.tar.gz"),        FPL(".gz") },
    { FPL("/foo.tar.gz.gz"),         FPL(".gz") },
    { FPL("."),                      FPL("") },
    { FPL(".."),                     FPL("") },
    { FPL("./foo"),                  FPL("") },
    { FPL("./foo.ext"),              FPL(".ext") },
