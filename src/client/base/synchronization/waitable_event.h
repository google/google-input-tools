...
#ifndef GOOPY_BASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define GOOPY_BASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
#pragma once
...
#endif  // GOOPY_BASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
