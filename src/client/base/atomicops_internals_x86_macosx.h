...
*/
#ifndef GOOPY_BASE_ATOMICOPS_INTERNALS_X86_MACOSX_H_
#define GOOPY_BASE_ATOMICOPS_INTERNALS_X86_MACOSX_H_
#pragma once
...
#endif  // GOOPY_BASE_ATOMICOPS_INTERNALS_X86_MACOSX_H_
