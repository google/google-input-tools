...
#ifndef GOOPY_BASE_THREADING_THREAD_COLLISION_WARNER_H_
#define GOOPY_BASE_THREADING_THREAD_COLLISION_WARNER_H_
#pragma once
...
#endif  // GOOPY_BASE_THREADING_THREAD_COLLISION_WARNER_H_
